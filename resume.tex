...
\begin{document}
\name{Pedro Ribeiro}
\tagline{Software Engineering Master}
...
\personalinfo{%
  ...
  \email{pedroalgoribeiro@gmail.com}
...
\cvevent{M.Sc. Computer Science}{University of Minho}{September 2020 -- December 2022}{Braga, PORTUGAL}
\begin{itemize}
...
\cvevent{Backend Developer @ WithUs - Technology Factory}{Full Time Remote Position}{August 2022 - Now}{Braga, PORTUGAL}
\begin{itemize}
    \item Assigned to AlticeLabs as a consultant.
\end{itemize}
